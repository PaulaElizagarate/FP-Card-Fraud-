...
def user_input_features():
    ...
    """
    distance_from_home = st.sidebar.slider('Distance from home', 1, 10633, 27) # the sidebar.slider magic function receive the max, min and default value in out sidebar
    distance_from_last_transaction = st.sidebar.slider('Distance from last transaction', 0.0001, 1185.5, 5.0)
    ratio_to_median_purchase_price = st.sidebar.slider('Median of purchase price', 0.004, 268.0, 1.82)
